...
const (
	_timeFormat = "2006-01-02T15:04:05.000"
...
type Handler interface {
	...
	// int is depth
	Log(context.Context, int, Level, ...D)
...
func (hs Handlers) Log(ctx context.Context, depth int, lv Level, d ...D) {
	hasSource := false
	for i := range d {
