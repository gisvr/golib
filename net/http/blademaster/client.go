...
type ClientConfig struct {
	...
	KeepAlive xtime.Duration           `yaml:"keepAlive"`
...
// Get issues a GetWithHeader to the specified URL.
func (client *Client) GetWithCookie(c context.Context, uri, ip string, params url.Values, cookies map[string]string, res interface{}) (err error) {
...
// Post issues a PostWithHeader to the specified URL.
func (client *Client) PostWithCookie(c context.Context, uri, ip string, params url.Values, cookies map[string]string, res interface{}) (err error) {
...
// Get issues a GetWithHeader to the specified URL.
func (client *Client) GetWithHeader(c context.Context, uri, ip string, params url.Values, header map[string]string, res interface{}) (err error) {
	req, err := client.NewRequest(xhttp.MethodGet, uri, ip, params)
	if err != nil {
		return
	}
...
// Post issues a PostWithHeader to the specified URL.
func (client *Client) PostWithHeader(c context.Context, uri, ip string, params url.Values, header map[string]string, res interface{}) (err error) {
	req, err := client.NewRequest(xhttp.MethodPost, uri, ip, params)
	if err != nil {
		return
	}
