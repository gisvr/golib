...
import (
	...
	"github/gisvr/wallet/src/lib/conf/flagvar"
	...
	"github/gisvr/wallet/src/lib/net/rpc/warden/balancer/p2c"
...
type ClientConfig struct {
	...
	Method                 map[string]*ClientConfig `yaml:"method"`
	...
	KeepAliveWithoutStream bool                     `yaml:"keepAliveWithoutStream"`
}
...
func (c *Client) DialNoTLS(ctx context.Context, target string, opts ...grpc.DialOption) (conn *grpc.ClientConn, err error) {
